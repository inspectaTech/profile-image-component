      ...
      var add_slider_input = function(nbr)
      {
        ...
        */
        ...
        //$("#lon_slider").on('change',function(){slideUpdate({'mode':gEd_mode,'dir':'longitude'});});
            ...
            sli_ctrl_inputB.oninput = function(){
              ...
              var input_val = (styleB == "goofy") ? val_goof_input : val_regular_input;
            ...
            sli_ctrl_inputA.oninput = function(){
              ...
              var input_val = (styleA == "goofy") ? val_goof_input : val_regular_input;
